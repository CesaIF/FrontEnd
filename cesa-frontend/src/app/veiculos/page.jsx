                        ...
                        <div className={styles.containerModal}>
                            <div className={styles.containerInternoModal}>
                                ...
                                <div className={styles.butaoForm}>
                                    ...
                                    <BadButton colorHover={"#769b6a"} cor={"#48793c"} onClick={() => {handleConfirmacaoIsOpen(); handleOpenModal(); setConfirmacao('cadastrado')}}>Criar Veículo</BadButton>
                                </div>
                            </div>
                        </div>
                    </Modal>
                        ...
                        <div className={styles.containerModal}>
                            <div className={styles.containerInternoModal}>
                                ...
                                <div className={styles.butaoForm}>
                                    ...
                                    <BadButton colorHover={"#769b6a"} cor={"#48793c"} onClick={() => {handleUpdateModal(); handleConfirmacaoIsOpen(); setConfirmacao('editado')}}>Atualizar Veículo</BadButton>
                                </div>
                            </div>
                        </div>
                    </Modal>
